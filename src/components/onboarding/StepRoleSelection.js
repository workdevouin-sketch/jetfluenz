    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 max-w-3xl mx-auto w-full">
                ...
                <motion.button
                    variants={fadeInUp}
                    whileHover={{ scale: 1.03, backgroundColor: 'rgba(255, 255, 255, 0.1)', borderColor: 'rgba(255,255,255,0.4)' }}
                    whileTap={{ scale: 0.98 }}
                    onClick={() => onSelect('influencer')}
                    className="group relative flex flex-col items-center p-6 md:p-12 rounded-2xl bg-white/5 border border-white/10 transition-all duration-300 text-left"
                >
