    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative w-full max-w-4xl bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden min-h-[600px] flex flex-col"
            >
                {/* Header / Close Button */}
                ...
                {/* Content Area */}
                <div className="flex-1 flex flex-col p-8 md:p-12 text-white">
